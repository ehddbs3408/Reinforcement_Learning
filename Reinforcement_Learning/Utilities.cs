...
namespace Reinforcement_Learning
{
    public static class Utilities
    {
        ...
        {
            IEnumerable<int> actionCandidates = GetGreedyActionCandidata(turn, actionValues);
        ...
        public static IEnumerable<int> GetGreedyActionCandidata(int turn,Dictionary<int,float> actionValues)
        {
            float greedyActionValue = 0.0f;
            if(actionValues.Count ==0)
            {
